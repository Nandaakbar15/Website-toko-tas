                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/toko/update') }}" method="post">
                        @csrf
                            ...
                            <div class="mb-3"><label for="kodetokolabel">Kode Toko</label><input class="form-control form-control-solid" id="kode_perusahaan" name="kode_perusahaan" type="text" placeholder="Contoh: PR-001" value="{{$perusahaan->kode_perusahaan}}" readonly></div>
                            
                            <div class="mb-3"><label for="namatokolabel">Nama Toko</label>
                            <input class="form-control form-control-solid" id="nama_toko" name="nama_toko" type="text" placeholder="Contoh: Sport Bag Shop" value="{{$toko->nama_toko}}">
                            </div>
                            
            
                            <div class="mb-0"><label for="alamattokolabel">Alamat Perusahaan</label>
                                <textarea class="form-control form-control-solid" id="alamat_perusahaan" name="alamat" rows="3" placeholder="Cth: Cimahi">{{$perusahaan->alamat}}</textarea>
                            </div>
                            <br>
                            <!-- untuk tombol simpan -->
